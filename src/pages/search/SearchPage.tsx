    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 text-center sm:mb-8">
          <h1 className="mb-3 text-2xl font-bold tracking-tight text-black sm:mb-4 sm:text-3xl md:text-4xl lg:text-5xl">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-4 py-2 text-sm font-medium text-gray-700 transition-all hover:border-gray-300 hover:bg-gray-100 sm:text-base"
          >
        ...
        {stats && (
          <div className="mt-6 inline-flex w-full max-w-xl flex-col items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm sm:mt-8 sm:w-auto sm:flex-row sm:gap-4 sm:rounded-full sm:px-6">
        ...
        {/* Results Area */}
        {results.length > 0 && (
          <div className="mt-8 w-full max-w-7xl sm:mt-12 lg:mt-16">
            <p className="mb-4 text-center text-sm text-gray-500 sm:mb-6 lg:mb-8">
        ...
        {/* Error State */}
        {error && (
          <div className="mt-8 w-full max-w-2xl border border-black bg-white p-4 text-center sm:mt-12 sm:p-6 lg:mt-16">
